...
import MindExercise from "@/components/MindExercise/MindExercise";
import { Button } from "@/components/ui/button";
import { ArrowLeft, Brain } from "lucide-react";
import { mindExercisesData } from "@/data/mindExercisesData";

export default function MindExerciseDetail() {
  ...
  useEffect(() => {
    ...
    const foundExercise = mindExercisesData.find(ex => ex.id === exerciseId);
  ...
  const handleBackToList = () => {
    navigate("/exercises/mind-exercise");
  };
