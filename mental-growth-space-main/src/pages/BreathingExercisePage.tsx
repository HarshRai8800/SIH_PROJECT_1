...
// Using the imported breathing exercises data from the central data file
...
export default function BreathingExercisePage() {
  ...
  const handleExerciseSelect = (exerciseId: string) => {
    navigate(`/exercises/breathing-exercise/${exerciseId}`);
    window.scrollTo(0, 0);
  };

  const filteredExercises = breathingExercisesData.filter(exercise => {
