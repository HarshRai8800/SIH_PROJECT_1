...
// Using the imported physical exercises data from the central data file
...
export default function PhysicalExercisePage() {
  ...
  const handleExerciseSelect = (exerciseId: string) => {
    navigate(`/exercises/physical-exercise/${exerciseId}`);
    window.scrollTo(0, 0);
  };

  const filteredExercises = physicalExercisesData.filter(exercise => {
